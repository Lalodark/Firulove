...
const Mascotas_CE: React.FC = () => {
  ...
  const opcionesRazaPorEspecie: Record<string, string[]> = {
    Perro: ['N/A', 'Afghan Hound', 'Akita', 'Alaskan Malamute', 'American Bulldog', 'American Staffordshire Terrier', 'Australian Shepherd',
    ...
    'Labrador Retriever', 'Mastín', 'Miniature Schnauzer', 'Norwegian Elkhound', 'Papillon', 'Pastor Alemán', 'Pembroke Welsh Corgi', 'Perro de Agua Portugués',
    ...
    Gato: ['N/A', 'Abisinio', 'American Curl', 'American Shorthair', 'American Wirehair', 'Angora Turco', 'Australian Mist', 'Azul Ruso', 'Bengal', 'Birmana', 'Bombay', 'British Shorthair', 
    ...
    Roedor: ['N/A','Ardilla de tierra', 'Ardilla de tierra común', 'Ardilla de tierra sudafricana', 'Cobaya de pelo corto',
    ...
    Pajaro: ['N/A', 'Agapornis', 'Ave exótica', 'Ave ornamental', 'Ave rapaz', 'Canario', 'Codorniz', 'Faisan', 'Gallina', 'Ganso', 'Loro', 'Paloma', 'Pato', 
